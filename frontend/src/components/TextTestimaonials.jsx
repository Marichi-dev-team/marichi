...
function TestimonialCard({ testimonial, isExpanded, onToggle }) {
  const truncatedContent = testimonial.content.length > 100
    ? testimonial.content.slice(0, 100) + '...'
    : testimonial.content;

  return (
    <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-lg mx-2" style={{ width: 'calc(100vw / 2 - 20px)', marginBottom: '8rem', marginTop: '2rem', height : "auto" , width : "auto"  }}>
      <img
...
const TextTestimonialsCarousel = () => {
  ...
  return (
    <div className="text-testimonials-container " style={{ marginBottom: '100px', marginTop: '2rem' }}>
      <Slider {...setting}>
        {testimonials.map((testimonial, index) => (
          <div key={index} className="text-testimonial-slide">
            <div className="text-testimonial-wrapper">
      ...
      <Slider {...setting}>
        {videoTestimonials.map((testimonial, index) => (
          <div key={index} className="testimonial-slide">
            <div className="video-wrapper" style={{ height : "560" , width : "315" }}>
              <iframe
                width="315"
                height="560"
                src={testimonial.src}
